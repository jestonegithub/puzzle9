...
// DEV ONLY - UNCOMMENT AFTER DEV
    ...
    //        strokeWidth: 2,color: '#FCB03C', text:{value:'Puzzle9'},fill: 'rgba(255,255,255,1)'
    //});
    //
    //   var start_button = new progressbar.Circle('#start_button', {strokeWidth:1, color:'#FCB03C',text:{value:'Start Game'},fill:'#ffffff'});
    //
